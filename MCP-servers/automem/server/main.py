...
async def status() -> str:
    ...
    try:
        ...
        qdrant_ok = False  # Qdrant not reachable
    ...
    try:
        ...
        llama_ok = False  # Embedding engine not available
    ...
    staging_dir = ensure_staging_buffer()
    staged_changes = sum(1 for _ in staging_dir.glob("*.json"))
    ...
    return json.dumps({
        ...
        "staging_buffer": str(staging_dir),
        "staged_change_sets": staged_changes,
